  ...
  <DefaultLayout>
    <div class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12">
        ...
        <p v-if="category.description" class="text-lg text-gray-600 dark:text-gray-300">{{ category.description }}</p>
      ...
      <div v-else class="text-center py-12">
        <p class="text-gray-600 dark:text-gray-300 text-lg">No posts found in this category. Check back soon!</p>
      </div>
